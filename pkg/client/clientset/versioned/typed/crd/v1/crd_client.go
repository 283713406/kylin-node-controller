...
import (
	...
	"github.com/kylin/kylin-node-controller/pkg/client/clientset/versioned/scheme"
...
func (c *CrdV1Client) KylinNodes(namespace string) KylinNodeInterface {
	return newKylinNodes(c, namespace)
}
